...
def view_cart():
    ...
    cart_content = []
    # Esse tipo de loop acessa o banco a cada iteração para retornar 1 dado, em aplicações grandes isso reduz a performance. Como esse curso é mais introdutório será mantido assim.
